...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/Naskleng/Bumbu_pepes/master/sources.list.debian7" --no-check-sertificate
...
sed -i 's/DROPBEAR_BANNER=""/DROPBEAR_BANNER="/etc/issue.net
